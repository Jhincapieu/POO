...
public class CasaConjuntoCerrado extends CasaUrbana{
    ...
    public CasaConjuntoCerrado(int identificadorInmobiliario, int area, String direccion, int numeroHabitaciones, int numeroBaños, int numeroPisos, int valorAdministracion, boolean tiemePiscina, boolean tieneCamposDeportivos) {
